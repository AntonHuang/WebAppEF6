...
namespace WebAppEF6
{
    ...
    public class ApplicationUserManager : UserManager<ApplicationUser>
    {
        ...
        public static ApplicationUserManager Create(IdentityFactoryOptions<ApplicationUserManager> options, ApplicationUserManager manager) 
        {
    ...
    public class ApplicationRoleManager : RoleManager<IdentityRole, string>
    {
        ...
        {
            return Create(context.Get<ApplicationDbContext>());
        }

        public static ApplicationRoleManager Create(DbContext context)
        {
            return new ApplicationRoleManager(new RoleStore<IdentityRole, string, IdentityUserRole>(context));
        }
    }
